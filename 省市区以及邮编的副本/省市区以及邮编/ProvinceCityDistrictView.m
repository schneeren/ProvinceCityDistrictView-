...
-(void)show
{
    ...
    if (_animateType == 0) {
        ...
        [UIView animateWithDuration:_animateTime-0.1 animations:^{
        ...
        [UIView animateWithDuration:_animateTime-0.1 delay:0 usingSpringWithDamping:0.7 initialSpringVelocity:0 options:UIViewAnimationOptionCurveLinear  animations:^{
